...
impl MontyObject {
    ...
    fn from_value(object: &Value, heap: &mut Heap<impl ResourceTracker>, interns: &Interns) -> Self {
    ...
    fn from_value_inner(
        ...
        match object {
            ...
            Value::Ref(id) => {
                ...
                let result = Self::from_heap_value(object, *id, heap, visited, interns);

                // Remove from visited set after processing
                visited.remove(id);
                // reduce depth after processing
